...
export default function Home() {
    ...
    const populateUsers = async () => {
        ...
        console.log(number1, localStorage.getItem('number'))
        console.log(number1)
        ...
        return(
          <div className="tracksuit boda-1 p-1 p-sm-5 br-10">
            ...
            <div className="" id='file'>
              ...
              <p className="ml-1 font3">TRK: {data.number}</p>

              <div className="d-g-pc">
                <img alt='Barcode Generator TEC-IT' height={100} width={270}
                    src={`https://barcode.tec-it.com/barcode.ashx?data=${data.number}&code=Code128&translate-esc=on`} />
                </div>

                <div className="clb-1  text-center py-3">
                    <p className="text-light">
                    Please kindly visit our online website: <span className="primary">https://kadxpress.com</span>, to track your shipment with our online tracking facility.
                    </p>
                </div>
